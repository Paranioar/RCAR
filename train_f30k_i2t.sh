...
CUDA_VISIBLE_DEVICES=${GPU_DEVICES} python3 train.py \
 ...
 --num_epochs=40 --lr_update=30 --learning_rate=.0005 --workers 10 \
 --log_step 100 --embed_size 1024 --vse_mean_warmup_epochs 3 \
 --attn_type i2t --t2i_smooth 10.0 --i2t_smooth 3.0 \
 --self_regulator only_rcr --rcar_step 0 --rcr_step 0 --rar_step 0


MODEL_NAME='f30k_i2t_rar2'
GPU_DEVICES='0'
DATASET_NAME='f30k'
DATA_PATH='./data/'${DATASET_NAME}
VOCAB_PATH='./data/vocab'
